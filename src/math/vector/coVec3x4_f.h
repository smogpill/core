...
coFORCE_INLINE coBool32x3x4 operator<(const coVec3x4& a, const coVec3x4& b) { return coBool32x3x4(a.x < b.x, a.y < b.y, a.z < b.z); }
coFORCE_INLINE coBool32x3x4 operator<(const coVec3x4& a, const coFloatx4& b) { return coBool32x3x4(a.x < b, a.y < b, a.z < b); }
coFORCE_INLINE coBool32x3x4 operator<=(const coVec3x4& a, const coVec3x4& b) { return coBool32x3x4(a.x <= b.x, a.y <= b.y, a.z <= b.z); }
...
coFORCE_INLINE coVec3x4 operator-(const coVec3x4& a, const coVec3x4& b) { return coVec3x4(a.x - b.x, a.y - b.y, a.z - b.z); }
coFORCE_INLINE coVec3x4 operator-(const coVec3x4& a, const coFloatx4& b) { return coVec3x4(a.x - b, a.y - b, a.z - b); }
coFORCE_INLINE coVec3x4& operator+=(coVec3x4& a, const coVec3x4& b) { a.x += b.x; a.y += b.y; a.z += b.z; return a; }
coFORCE_INLINE coVec3x4& operator-=(coVec3x4& a, const coVec3x4& b) { a.x -= b.x; a.y -= b.y; a.z -= b.z; return a; }
coFORCE_INLINE coVec3x4& operator*=(coVec3x4& a, const coVec3x4& b) { a.x *= b.x; a.y *= b.y; a.z *= b.z; return a; }
coFORCE_INLINE coVec3x4& operator/=(coVec3x4& a, const coVec3x4& b) { a.x /= b.x; a.y /= b.y; a.z /= b.z; return a; }
...
coFORCE_INLINE coVec3x4 coSplatx4(const coVec3& a)
{
	coVec3x4 o(nullptr);
	o.x = coSplatX(coFloatx4(a));
	o.y = coSplatY(coFloatx4(a));
	o.z = coSplatZ(coFloatx4(a));
	return o;
}
