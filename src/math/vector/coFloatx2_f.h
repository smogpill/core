...
coFORCE_INLINE coBool32x2 operator< (const coFloatx2& _a, const coFloatx2& _b) { return coBitCast<coBool32x2>(_mm_cmplt_ps(coBitCast<__m128>(_a), coBitCast<__m128>(_b))); }
...
coFORCE_INLINE coFloatx2 coAbs(const coFloatx2& _a) { return coBitCast<coFloatx2>(coAbs(coBitCast<coFloatx4>(_a))); }
coFORCE_INLINE coBool32x2 coNearEqual0(const coFloatx2& _a, const coFloatx2& _epsilon = coFloatx2(coFloat_NearEqualDefaultEpsilon)) { return coAbs(_a) < _epsilon; }
