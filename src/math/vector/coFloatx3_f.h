...
coFORCE_INLINE coFloatx3 coMulAdd(const coFloatx3& a, const coFloatx3& b, const coFloatx3& c) { return a * b + c; }
...
coFORCE_INLINE coFloatx3 coInvert(const coFloatx3& _a) { return coBitCast<coFloatx3>(coInvert(coBitCast<coFloatx4>(_a))); }
coFORCE_INLINE coFloatx3 coInvertFast(const coFloatx3& _a) { return coBitCast<coFloatx3>(coInvertFast(coBitCast<coFloatx4>(_a))); }
...
coFORCE_INLINE coFloatx3 coSelect(const coFloatx3& _a, const coFloatx3& _b, const coInt32x3& _mask)
{
	return coBitCast<coFloatx3>(coBitCast<coInt32x3>(_b) ^ _mask & (coBitCast<coInt32x3>(_a) ^ coBitCast<coInt32x3>(_b)));
}
coFORCE_INLINE coFloatx3 coSign(const coFloatx3& x) { return coSelect(1.0f, -1.0f, coBitCast<coInt32x3>(x >= 0.f)); }
