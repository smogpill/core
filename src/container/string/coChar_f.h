...
coFORCE_INLINE coBool coIsDigitOrPeriodOrSign(coChar _c) { return (_coCharCategoryTable[_c] & (_coCharCategory_digit | _coCharCategory_period | _coCharCategory_sign)) != 0; }
