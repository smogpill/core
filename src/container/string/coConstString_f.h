...
coConstString coGetSubStringFromPos(const coConstString& _s, coUint32 _pos);
coConstString coGetSubStringFromSize(const coConstString& _s, coUint32 _size);
coConstString ccoGetSubStringAfterToken(const coConstString& _s, const coConstString& _token);
