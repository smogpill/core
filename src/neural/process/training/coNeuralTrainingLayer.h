...
public:
	...
	coDynamicArray<coFloat> biasMs; // Used by Adam
	coDynamicArray<coFloat> weightMs; // Used by Adam
	coDynamicArray<coFloat> biasVs; // Used by Adam
	coDynamicArray<coFloat> weightVs; // Used by Adam
